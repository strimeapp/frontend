...
function resizeImageAndCommentsContainer() {
    ...
    if(isMobile == false) {
        ...
        var imageMetaHeight = $("#image #asset-meta").outerHeight();
        ...
        // Define the height of image container and of the comments container
        var imageContainerHeight = windowHeight - headerHeight - imageMetaHeight - contentPaddingBottom - footerHeight - bodyMarginBottom + 10;
        ...
        // Set these values
        $("#image #image-container").css("height", imageContainerHeight+"px");
